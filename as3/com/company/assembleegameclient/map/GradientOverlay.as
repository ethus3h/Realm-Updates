...
package com.company.assembleegameclient.map{
    ...
    public class GradientOverlay extends Shape {
        ...
        private const gradientGraphicsData_:Vector.<IGraphicsData> = new <flash.display.IGraphicsData>[GradientOverlay.gradientFill_, GradientOverlay.gradientPath_, com.company.util.GraphicsUtil.END_FILL];
