...
package com.company.assembleegameclient.account.ui{
    ...
    public class Frame extends Sprite {
        ...
        private const graphicsData_:Vector.<IGraphicsData> = new <flash.display.IGraphicsData>[Frame.backgroundFill_, Frame.path2_, com.company.util.GraphicsUtil.END_FILL, Frame.titleFill_, Frame.path1_, com.company.util.GraphicsUtil.END_FILL, Frame.lineStyle_, Frame.path2_, com.company.util.GraphicsUtil.END_STROKE];
