...
package com.company.assembleegameclient.ui.menu{
    ...
    public class Menu extends Sprite implements UnFocusAble {
        ...
        private const graphicsData_:Vector.<IGraphicsData> = new <flash.display.IGraphicsData>[Menu.lineStyle_, Menu.backgroundFill_, Menu.path_, com.company.util.GraphicsUtil.END_FILL, com.company.util.GraphicsUtil.END_STROKE];
