...
package kabam.rotmg.util.components{
    ...
    public class SpriteBackground extends Sprite {
        ...
        private const graphicsData:Vector.<IGraphicsData> = new <flash.display.IGraphicsData>[SpriteBackground.enabledFill, SpriteBackground.graphicsPath, com.company.util.GraphicsUtil.END_FILL];
