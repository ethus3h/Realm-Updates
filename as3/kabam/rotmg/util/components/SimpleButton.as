...
package kabam.rotmg.util.components{
    ...
    public class SimpleButton extends BuyButton {
        ...
        private const graphicsData:Vector.<IGraphicsData> = new <flash.display.IGraphicsData>[SimpleButton.enabledFill, SimpleButton.graphicsPath, com.company.util.GraphicsUtil.END_FILL];
