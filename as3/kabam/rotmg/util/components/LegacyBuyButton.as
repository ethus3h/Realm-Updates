...
package kabam.rotmg.util.components{
    ...
    public class LegacyBuyButton extends BuyButton {
        ...
        private const graphicsData:Vector.<IGraphicsData> = new <flash.display.IGraphicsData>[LegacyBuyButton.enabledFill, LegacyBuyButton.graphicsPath, com.company.util.GraphicsUtil.END_FILL];
