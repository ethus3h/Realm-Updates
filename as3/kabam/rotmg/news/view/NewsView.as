...
package kabam.rotmg.news.view{
    ...
    public class NewsView extends Sprite {
        ...
        private const cellOne:NewsCell = new NewsCell(NewsView.LARGE_CELL_WIDTH, NewsView.LARGE_CELL_HEIGHT);
        private const cellTwo:NewsCell = new NewsCell(NewsView.SMALL_CELL_WIDTH, NewsView.SMALL_CELL_HEIGHT);
        private const cellThree:NewsCell = new NewsCell(NewsView.SMALL_CELL_WIDTH, NewsView.SMALL_CELL_HEIGHT);
