...
package kabam.rotmg.characters.reskin.view{
    ...
    public class ReskinCharacterView extends Sprite {
        ...
        public const cancelled:Signal = new org.osflash.signals.natives.NativeMappedSignal(ReskinCharacterView.cancel, flash.events.MouseEvent.CLICK);
        public const selected:Signal = new org.osflash.signals.natives.NativeMappedSignal(ReskinCharacterView.select, flash.events.MouseEvent.CLICK);
