...
package kabam.rotmg.pets.view.components{
    ...
    public class FeedFuseArrow extends Sprite {
        ...
        private const designGraphicsData_:Vector.<IGraphicsData> = new <flash.display.IGraphicsData>[FeedFuseArrow.designFill_, FeedFuseArrow.designPath_, com.company.util.GraphicsUtil.END_FILL];
