...
package kabam.rotmg.classes.view{
    ...
    public class CharacterSkinListItem extends Sprite {
        ...
        public const buy:Signal = new org.osflash.signals.natives.NativeMappedSignal(CharacterSkinListItem.buyButtonContainer, flash.events.MouseEvent.CLICK);
        public const over:Signal = new Signal();
        public const out:Signal = new Signal();
        public const selected:Signal = CharacterSkinListItem.selectionButton.changed;
