...
package org.swiftsuspenders.reflection{
    ...
    public class DescribeTypeReflector extends ReflectorBase implements Reflector {
        ...
        private function addCtorInjectionPoint(_arg1:TypeDescription, _arg2:Class):void{
            var injectParameters:Dictionary;
            var parameters:Array;
            var description:TypeDescription = _arg1;
        ...
        private function addFieldInjectionPoints(_arg1:TypeDescription):void{
            var node:XML;
        ...
        private function addMethodInjectionPoints(_arg1:TypeDescription):void{
            var node:XML;
            var injectParameters:Dictionary;
        ...
        private function gatherOrderedInjectionPointsForTag(_arg1:Class, _arg2:String):Array{
            var node:XML;
            var injectParameters:Dictionary;
            var parameterNames:Array;
            var parameters:Array;
